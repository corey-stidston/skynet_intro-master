...
# generator for 4096 bit raw prime
generator = 2

# Performs DH key exchange, creates DH key
...
# Returns a shared secret which can be used to compute other settings
